...
#Initializinh and training the Decision Tree Regressor
...
#Getting the user input and making predictions
...
predict_house_price()
#Reordering the columns so they match the training data
